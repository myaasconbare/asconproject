    ...
    <div class="main-nav sidebar-menu-container">
        <ul class="sidebar-menu">
            ...
            <x-user.sidebar-menu-item
                label="Dashboard"
                pattern="{{ routeName('user.dashboard') }}"
                >
                <x-slot:icon>
            ...
            <x-user.sidebar-menu-item
                label="Transaction"
                pattern="{{ routeName('user.transactions') }}"
                >
                <x-slot:icon>
            ...
            <x-user.sidebar-menu-item
                label="Reward Badges"
                pattern="{{ routeName('user.investment-rewards') }}"
                >
                <x-slot:icon>
            ...
            <x-user.sidebar-menu-item
                ...
                <x-slot:dropdown>
                    <ul class="sub-menu">
                        <x-user.sub-menu-item
                            label="Scheme"
                            pattern="{{ routeName('user.matrix') }}"
                        />
                        <x-user.sub-menu-item
                        ...
                        <x-user.sub-menu-item
                            label="Commissions"
                            pattern="{{ routeName('user.commissions') }}"
                        />
                    </ul>
                </x-slot:dropdown>
            </x-user.sidebar-menu-item>
            ...
            <x-user.sidebar-menu-item
                ...
                <x-slot:dropdown>
                    <ul class="sub-menu">
                        <x-user.sub-menu-item
                            label="Scheme"
                            pattern="{{ routeName('user.investment') }}"
                        />
                        <x-user.sub-menu-item
                            label="Active"
                            pattern="{{ routeName('user.active-investments') }}"
                        />
                        <x-user.sub-menu-item
                            label="History"
                            pattern="{{ routeName('user.investment-records') }}"
                        />
                        <x-user.sub-menu-item
            ...
            <x-user.sidebar-menu-item
                ...
                pattern="{{ routeName('user.staking-investment') }}"
            >
                <x-slot:icon>
            ...
            <x-user.sidebar-menu-item
                ...
                <x-slot:dropdown>
                    <ul class="sub-menu">
                        <x-user.sub-menu-item
                            label="Trade Now"
                            pattern="{{ routeName('user.trade') }}"
                        />
                        <x-user.sub-menu-item
                            label="History"
                            pattern="{{ routeName('user.trade-records') }}"
                        />
                        <x-user.sub-menu-item
                            label="Practices"
            ...
            <x-user.sidebar-menu-item
                ...
                <x-slot:dropdown>
                    <ul class="sub-menu">
                        <x-user.sub-menu-item
                            label="Instant"
                            pattern="{{ routeName('user.deposit') }}"
                        />
                        <x-user.sub-menu-item
                            label="Commissions"
            ...
            <x-user.sidebar-menu-item
                label="Referrals"
                pattern="{{ routeName('user.referrals') }}"
            >
                <x-slot:icon>
            ...
            <x-user.sidebar-menu-item
                label="Cashout"
                pattern="{{ routeName('user.cash-out') }}"
            >
                <x-slot:icon>
            ...
            <li class="sidebar-menu-item">
                <a @class(['sidebar-menu-link', 'active' => request()->routeIs('user.insta-pin-recharge')]) href="{{ route('user.insta-pin-recharge') }}" aria-expanded="false">
            ...
            <x-user.sidebar-menu-item
                label="Settings"
                pattern="{{ routeName('user.settings') }}"
            >
                <x-slot:icon>
