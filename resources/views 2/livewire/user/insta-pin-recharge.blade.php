<div x-data="instaPin">
            ...
            <div class="col-lg-12">
                <div class="i-card-sm">
                    <div class="card-header">
                        <h4 class="title">Recharge Your Wallet</h4>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-lg-6">
                                            ...
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                <div class="avatar--xl rounded-0 mb-3 opacity-75">
                                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                        ...
                                                        viewbox="0 0 60 60" xml:space="preserve" class="">
                                                        <g>
                                                            <path
                                                ...
                                                <button class="arrow--btn deposit-process" data-bs-toggle="modal"
                                                    data-bs-target="#rechargeModal">
                                                    Recharge Now<i class="bi bi-box-arrow-up-right ms-2"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-7 col-md-7 col-sm-7 text-end">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                ...
                                                <button class="arrow--btn deposit-process" data-bs-toggle="modal"
                                                    ...
                                                    Generate New Pin<i class="bi bi-box-arrow-up-right ms-2"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row mt-4">
            <div class="col-lg-12">
                <div class="i-card-sm">
                            ...
                            <table id="myTable" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Pin Number">
                                            {{ $pin->number }}
                                            <span class="reference-copy" data-pin="{{ $pin->number }}"><i
                                                    class="las la-copy"></i></span>
                                        </td>
                                        <td data-label="Status">
                                            <span class="i-badge badge--{{ $pin->status_color }} capsuled">
                                                {{ ucwords($pin->status) }}
                                            </span>
                                        </td>
                    ...
                    {{ $pins->appends($_GET)->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>

    <div wire:ignore.self class="modal fade" id="rechargeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg--dark">
                    <h5 class="modal-title">Top up Now</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form wire:submit.prevent='submitRechargeForm'>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="pin_number" class="col-form-label">Pin Number</label>
                            <input wire:model='instaPinRechargeForm.number' type="text" class="form-control"
                                id="pin_number" name="pin_number" placeholder="Enter Pin Number" required="" />
                        </div>
                    </div>

                    <div class="modal-footer">
                        <button type="button" class="i-btn btn--light btn--md" data-bs-dismiss="modal">
                            Close
                        </button>
                        <button type="submit" class="i-btn btn--primary btn--md spin-btn-sm">
                            <x-spinner wire:loading.class='d-flex' wire:target='submitRechargeForm' />
                            Submit
                        </button>
                    </div>
                </form>
    ...
    <div wire:ignore.self class="modal fade" id="generateModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg--dark">
                    <h5 class="modal-title">Generated New Pins</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <form wire:submit.prevent='submitGenerateForm'>
                    <div class="modal-body">
                        <div class="text-start">
                            <p class="mb-2 fw-bold">
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model='instaPinGenerateForm.amount' type="text" class="form-control" id="amount"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="i-btn btn--primary btn--md spin-btn-sm">
                            <x-spinner wire:loading.class='d-flex' wire:target='submitGenerateForm' />
                            Submit
                        </button>
                    </div>
                </form>
