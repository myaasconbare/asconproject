            ...
            <div class="row justify-content-center align-items-center gy-5">
                <div class="col-xl-6 col-lg-6">
                    <div class="form-left">
                        ...
                        <p>
                            Embark on a journey with {{ config('app.name') }}, where innovation meets opportunity in the dynamic world of blockchain and cryptocurrency. As the market evolves with heightened interest and regulatory developments, position
                            yourself for success with our advanced, secure platform. Begin your trading adventure with a welcome bonus!
                        </p>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-inner">
                                        ...
                                        <input type="text" id="name" name="name" wire:model="form.name"  placeholder="Enter Name" require="" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-inner">
                                        ...
                                        <input type="text" id="email" name="email" wire:model="form.email"  placeholder="Enter Email" require="" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-inner">
                                        ...
                                        <input type="password" id="password" name="password" wire:model="form.password" autocomplete="new-password" placeholder="Enter Password" require="" aria-autocomplete="list" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-inner">
                                        ...
                                        <input type="password" id="password_confirmation" name="password_confirmation" wire:model="form.password_confirmation" autocomplete="new-password" placeholder="Enter Confirm Password" require="" />
                                    </div>
                                </div>

                                <div class="col-12">
                                    <button type="submit" value="Register" class="i-btn btn--lg btn--primary w-100 spin-btn">
