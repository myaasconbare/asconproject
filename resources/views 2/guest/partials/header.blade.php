    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <div class="main-nav">
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item-has-children">
                    <a href="{{ route('guest.trade') }}" @class(['dropdown', "active" => request()->routeIs("guest.trade") ])">Trade</a>
                </li>
                ...
                <li><a href="{{ route('guest.contact') }}" @class(["active" => request()->routeIs("guest.contact") ])">Contact</a></li>
            </ul>
