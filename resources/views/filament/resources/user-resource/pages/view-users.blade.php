                            ...
                            <div class="col-span-full">
                                <div>
                                    <div class="relative  rounded-lg  dark:bg-gray-800" id="stats" role="tabpanel"
                                        ...
                                        <img class=" absolute object-cover w-full h-full md:h-[150px] rounded-xl"
                                            src="https://i.imgur.com/kGkSg1v.png"
                                            style="opacity: 0.2;filter: hue-rotate(45deg);">
                                        <div class="absolue p-4 top-0">
                                            <div
                                                class="grid max-w-screen-xl  md:grid-cols-3 gap-8  mx-auto text-gray-900  dark:text-white sm:p-8">
                                ...
                                <br>
                                <div class=" shadow rounded-lg flex flex-col gap-4 md:gap-0 md:flex-row">
                                    <div style="background-image: url(https://i.imgur.com/kGkSg1v.png);background-repeat: no-repeat;object-fit: cover;background-size: 100% 100%;"
                                        class="w-full md:w-auto m-auto rounded-xl relative text-white">
