...
<main x-data='login' wire:ignore>
    ...
    <div class="form-section white img-adjust">
        ...
        <div class="form-bg2" onclick="let vid = document.querySelector('#pool-video'); vid.play(); alert('muu');">
        ...
        <div class="container-fluid px-0">
            <div class="row justify-content-center align-items-center gy-5">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-inner">
                                        ...
                                        <input type="email" name="email" wire:model="form.email" id="email" value=""
                                ...
                                <div class="col-12">
                                    <div class="form-inner">
                                        ...
                                        <input type="password" id="password" name="password" wire:model="form.password"
                                            value="" autocomplete="current-password" placeholder="Enter Password"
                                            required />
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    ...
                                    <div
                                        class="col-sm-6 text-sm-end text-start d-flex justify-content-sm-end justify-content-start">
                ...
                <div class="col-xl-6 col-lg-6"
                    onclick="let vid = document.querySelector('#pool-video'); vid.play(); alert('muu');">
                    <div class="form-left d-md-none">
                        ...
                        <p>
                            Enter the realm of {{ config("app.name") }}, where cutting-edge blockchain technology meets
                            seamless trading experiences. As the industry evolves amidst global regulatory developments,
                            stay ahead with our secure, intuitive
