<div class="main-content" data-simplebar="">
    ...
    <div class="row">
        <div class="col-12">
            <div class="i-card-sm mb-4 p-3 d-flex justify-content-between align-items-center">
                <livewire:user.partials.auto-compound-button/>
                <livewire:user.partials.redeem-license-button/>
            </div>
        </div>
    </div>
    <div class="row">
